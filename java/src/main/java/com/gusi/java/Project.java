...
public class Project {
    ...
    private String mReceiveMaterial;
    ...
    public String getReceiveMaterial() {
        return mReceiveMaterial;
    }

    public void setReceiveMaterial(String receiveMaterial) {
        mReceiveMaterial = receiveMaterial;
    }
    ...
    public String toString() {
        return "Project{" +
                ...
                ", mOverview='" + mOverview + '\'' +
                ", mNotice='" + mNotice + '\'' +
                ", mPublicResult='" + mPublicResult + '\'' +
                ", mProgress='" + mProgress + '\'' +
                ", mEnterprise='" + mEnterprise + '\'' +
                ", mRegisterTime='" + mRegisterTime + '\'' +
                ", mBuildingNum='" + mBuildingNum + '\'' +
                ", mPresaleNum='" + mPresaleNum + '\'' +
                ", mReceiveMaterial='" + mReceiveMaterial + '\'' +
                ", mReceiveSite='" + mReceiveSite + '\'' +
                ", mPhone='" + mPhone + '\'' +
                '}';
    }
}
