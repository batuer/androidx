...
import static com.gusi.contacts.util.PermissionsUtil.hasPermission;
 ...
 *
 * $ adb shell pm revoke com.gusi.contacts android.permission.READ_CONTACTS
 * $ adb shell pm revoke com.gusi.contacts android.permission.WRITE_CONTACTS
 * $ adb shell pm revoke com.gusi.contacts android.permission.GET_ACCOUNTS
 * $ adb shell pm revoke com.gusi.contacts android.permission.READ_PHONE_STATE
 * $ adb shell pm revoke com.gusi.contacts android.permission.CALL_PHONE
 * $ adb shell am instrument -w \
 *     com.google.android.contacts.tests/androidx.test.runner.AndroidJUnitRunner \
 *     -e class com.gusi.contacts.NoPermissionsLaunchSmokeTest
 */
@MediumTest
