 ...
 * {@link com.gusi.contacts.tests.AdbHelpers}
 *
 * Valid signatures: void f(Context, Bundle), void f(Context), void f()
 *
 * Example usage:
 * $ adb shell am instrument -e class com.gusi.contacts.Foo -e method bar -e someArg someValue\
 *   -w com.google.android.contacts.tests/com.gusi.contacts.RunMethodInstrumentation
 */
