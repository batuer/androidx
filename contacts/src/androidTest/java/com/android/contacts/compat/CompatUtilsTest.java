...
package com.gusi.contacts.compat;
...
public class CompatUtilsTest extends AndroidTestCase {
    ...
    public void testIsClassAvailable_NonexistentClass() {
        assertFalse(CompatUtils.isClassAvailable("com.gusi.contacts.common.NonexistentClass"));
    }
    ...
    public void testIsMethodAvailable_NonexistentClass() {
        assertFalse(CompatUtils.isMethodAvailable("com.gusi.contacts.common.NonexistentClass",
                ""));
    }
