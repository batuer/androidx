...
package com.gusi.contacts.quickcontact;
...
import com.gusi.contacts.CallUtil;
import com.gusi.contacts.ClipboardUtils;
import com.gusi.contacts.Collapser;
import com.gusi.contacts.ContactSaveService;
import com.gusi.contacts.ContactsActivity;
import com.gusi.contacts.ContactsUtils;
import com.gusi.contacts.DynamicShortcuts;
import com.gusi.contacts.NfcHandler;
import com.gusi.contacts.R;
import com.gusi.contacts.ShortcutIntentBuilder;
import com.gusi.contacts.ShortcutIntentBuilder.OnShortcutIntentCreatedListener;
import com.gusi.contacts.activities.ContactEditorActivity;
import com.gusi.contacts.activities.ContactSelectionActivity;
import com.gusi.contacts.activities.RequestPermissionsActivity;
import com.gusi.contacts.compat.CompatUtils;
import com.gusi.contacts.compat.EventCompat;
import com.gusi.contacts.compat.MultiWindowCompat;
import com.gusi.contacts.detail.ContactDisplayUtils;
import com.gusi.contacts.dialog.CallSubjectDialog;
import com.gusi.contacts.editor.ContactEditorFragment;
import com.gusi.contacts.editor.EditorIntents;
import com.gusi.contacts.editor.EditorUiUtils;
import com.gusi.contacts.interactions.ContactDeletionInteraction;
import com.gusi.contacts.interactions.TouchPointManager;
import com.gusi.contacts.lettertiles.LetterTileDrawable;
import com.gusi.contacts.list.UiIntentActions;
import com.gusi.contacts.logging.Logger;
import com.gusi.contacts.logging.QuickContactEvent.ActionType;
import com.gusi.contacts.logging.QuickContactEvent.CardType;
import com.gusi.contacts.logging.QuickContactEvent.ContactType;
import com.gusi.contacts.logging.ScreenEvent.ScreenType;
import com.gusi.contacts.model.AccountTypeManager;
import com.gusi.contacts.model.Contact;
import com.gusi.contacts.model.ContactLoader;
import com.gusi.contacts.model.RawContact;
import com.gusi.contacts.model.account.AccountType;
import com.gusi.contacts.model.dataitem.CustomDataItem;
import com.gusi.contacts.model.dataitem.DataItem;
import com.gusi.contacts.model.dataitem.DataKind;
import com.gusi.contacts.model.dataitem.EmailDataItem;
import com.gusi.contacts.model.dataitem.EventDataItem;
import com.gusi.contacts.model.dataitem.ImDataItem;
import com.gusi.contacts.model.dataitem.NicknameDataItem;
import com.gusi.contacts.model.dataitem.NoteDataItem;
import com.gusi.contacts.model.dataitem.OrganizationDataItem;
import com.gusi.contacts.model.dataitem.PhoneDataItem;
import com.gusi.contacts.model.dataitem.RelationDataItem;
import com.gusi.contacts.model.dataitem.SipAddressDataItem;
import com.gusi.contacts.model.dataitem.StructuredNameDataItem;
import com.gusi.contacts.model.dataitem.StructuredPostalDataItem;
import com.gusi.contacts.model.dataitem.WebsiteDataItem;
import com.gusi.contacts.quickcontact.ExpandingEntryCardView.Entry;
import com.gusi.contacts.quickcontact.ExpandingEntryCardView.EntryContextMenuInfo;
import com.gusi.contacts.quickcontact.ExpandingEntryCardView.EntryTag;
import com.gusi.contacts.quickcontact.ExpandingEntryCardView.ExpandingEntryCardViewListener;
import com.gusi.contacts.quickcontact.WebAddress.ParseException;
import com.gusi.contacts.util.DateUtils;
import com.gusi.contacts.util.ImageViewDrawableSetter;
import com.gusi.contacts.util.ImplicitIntentsUtil;
import com.gusi.contacts.util.MaterialColorMapUtils;
import com.gusi.contacts.util.MaterialColorMapUtils.MaterialPalette;
import com.gusi.contacts.util.PhoneCapabilityTester;
import com.gusi.contacts.util.SchedulingUtils;
import com.gusi.contacts.util.SharedPreferenceUtil;
import com.gusi.contacts.util.StructuredPostalUtils;
import com.gusi.contacts.util.UriUtils;
import com.gusi.contacts.util.ViewUtil;
import com.gusi.contacts.widget.MultiShrinkScroller;
import com.gusi.contacts.widget.MultiShrinkScroller.MultiShrinkScrollerListener;
import com.gusi.contacts.widget.QuickContactImageView;
import com.gusi.contactsbind.HelpUtils;
...
public class QuickContactActivity extends ContactsActivity {
    ...
    private static final String CALL_ORIGIN_QUICK_CONTACTS_ACTIVITY =
            "com.gusi.contacts.quickcontact.QuickContactActivity";
    ...
    private static Entry dataItemToEntry(DataItem dataItem, DataItem secondDataItem,
        ...
        if (dataItem instanceof ImDataItem) {
            ...
            if (!TextUtils.isEmpty(phone.getNumber())) {
                ...
                phoneContentDescription = com.gusi.contacts.util.ContactDisplayUtils
                ...
                smsContentDescription = com.gusi.contacts.util.ContactDisplayUtils
