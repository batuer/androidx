...
package com.gusi.contacts.vcard;
...
import com.gusi.contacts.activities.RequestImportVCardPermissionsActivity;
...
import com.gusi.vcard.VCardEntryCounter;
...
import com.gusi.vcard.exception.VCardNestedException;
...
public class ImportVCardActivity extends Activity implements ImportVCardDialogFragment.Listener {
    ...
    private static final String LOCAL_TMP_FILE_NAME_EXTRA =
            "com.gusi.contacts.vcard.LOCAL_TMP_FILE_NAME";

    private static final String SOURCE_URI_DISPLAY_NAME =
            "com.gusi.contacts.vcard.SOURCE_URI_DISPLAY_NAME";
