...
package com.gusi.contacts.activities;
...
import com.gusi.contacts.AppCompatContactsActivity;
import com.gusi.contacts.ContactSaveService;
import com.gusi.contacts.R;
import com.gusi.contacts.compat.CompatUtils;
import com.gusi.contacts.drawer.DrawerFragment;
import com.gusi.contacts.drawer.DrawerFragment.DrawerFragmentListener;
import com.gusi.contacts.editor.ContactEditorFragment;
import com.gusi.contacts.editor.SelectAccountDialogFragment;
import com.gusi.contacts.group.GroupListItem;
import com.gusi.contacts.group.GroupMembersFragment;
import com.gusi.contacts.group.GroupNameEditDialogFragment;
import com.gusi.contacts.group.GroupUtil;
import com.gusi.contacts.list.AccountFilterActivity;
import com.gusi.contacts.list.ContactListFilter;
import com.gusi.contacts.list.ContactListFilterController;
import com.gusi.contacts.list.ContactListFilterController.ContactListFilterListener;
import com.gusi.contacts.list.ContactsIntentResolver;
import com.gusi.contacts.list.ContactsRequest;
import com.gusi.contacts.list.ContactsUnavailableFragment;
import com.gusi.contacts.list.DefaultContactBrowseListFragment;
import com.gusi.contacts.list.MultiSelectContactsListFragment;
import com.gusi.contacts.list.ProviderStatusWatcher;
import com.gusi.contacts.list.ProviderStatusWatcher.ProviderStatusListener;
...
import com.gusi.contacts.model.account.AccountInfo;
import com.gusi.contacts.model.account.AccountWithDataSet;
import com.gusi.contacts.preference.ContactsPreferenceActivity;
import com.gusi.contacts.util.AccountFilterUtil;
import com.gusi.contacts.util.Constants;
...
import com.gusi.contacts.util.SyncUtil;
import com.gusi.contacts.util.ViewUtil;
import com.gusi.contacts.widget.FloatingActionButtonController;
import com.gusi.contactsbind.FeatureHighlightHelper;
import com.gusi.contactsbind.HelpUtils;
import com.gusi.contactsbind.ObjectFactory;
...
public class PeopleActivity extends AppCompatContactsActivity implements
    ...
    private class ContactsActionBarDrawerToggle extends ActionBarDrawerToggle {
        ...
        private void stopSearchAndSelection() {
            ...
            final com.gusi.contacts.activities.ActionBarAdapter actionBarAdapter = listFragment.getActionBarAdapter();
    ...
    protected void onCreate(Bundle savedState) {
        ...
        com.gusi.contacts.activities.RequestPermissionsActivity.startPermissionActivityIfNeeded(this);
